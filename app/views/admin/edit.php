...
<form action="<?php echo BASE_URL; ?>/admin/edit.php" method="POST" autocomplete="off">
	...
	<label for="label">
		Label
		<input type="text" name="label" id="label" value="<?php echo escape( $page['title'] ); ?>">
	</label>
	...
	<label for="body">
		Body
		<textarea type="textarea" name="body" id="body" cols="30" rows="10"><?php echo escape( $page['body'] ); ?></textarea>
	</label>
